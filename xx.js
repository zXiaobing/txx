    ...
    (function($, css, run) {
        ...
        function selectVideo () {
            ...
            new Promise(resolve => {
                ...
                let items = document.getElementsByClassName('text-link-item-title')//$('.text-link-item-title')
                console.log(items);
        ...
        function selectArticle () {
            new Promise(resolve => {
                ...
                let items = document.getElementsByClassName('text-link-item-title') //$('.text-link-item-title') //document.getElementsByClassName('text-link-item-title')//
                window.open = url => { location.href = url };
                let id = parseInt(Math.random() * (items.length - 1));
                items[id].childNodes[0].click();
            });
        ...
        function main () {
            ...
            if (/<span.*?>学习理论<\/span>/.test(document.body.innerHTML) && !/<a.*?>学习强国<\/a><span.*?>&gt;&gt;<\/span><span.*?>学习理论<\/span>/.test(document.body.innerHTML)) {
                selectArticle()
                return
            }
            if (/<a.*?>学习强国<\/a><span.*?>&gt;&gt;<\/span><span.*?>学习理论<\/span>/.test(document.body.innerHTML)) {//document.body.innerHTML.indexOf('打印') >= 0 && document.body.innerHTML.indexOf('编辑') >= 0) {
                autoRead(250)
                return
            }
